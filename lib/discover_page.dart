      ...
      body: GetBuilder<Controller>(
        ...
        builder: (controller) {
          return Column(
            children: [
              Expanded(
                // 这里使用了flutter_staggered_grid_view库，可以生成瀑布流效果
                child: MasonryGridView.count(
                  controller: controller.scrollController,
                  crossAxisCount: 2,
                  itemCount:
                      controller.movieData.length + (controller.isLoading ? 1 : 0),
